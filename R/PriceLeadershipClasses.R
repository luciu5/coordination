#' @importClassesFrom antitrust Logit LogitBLP
NULL
...
#'@description \code{PriceLeadership} and \code{PriceLeadershipBLP} are S4
#'  classes representing calibrated price leadership equilibrium models.
#'  \code{PriceLeadership} extends \code{\linkS4class{Logit}} (Logit demand);
#'  \code{PriceLeadershipBLP} extends antitrust's \code{LogitBLP}
#'  (random-coefficients BLP demand).
#'@export
setClass(
...
#'@rdname PriceLeadership-Classes
#'@name PriceLeadershipBLP-Classes
#'@aliases PriceLeadershipBLP-class
#'@export
setClass(
