#' @importClassesFrom antitrust Bertrand
NULL

#' @title Grim Trigger Sustainability Analysis
#' @name GrimTrigger-methods
#' @docType methods
#' @aliases calcProducerSurplusGrimTrigger calcProducerSurplusGrimTrigger,Bertrand-method
#'
...
#'
#' @param object An instance of the Bertrand class (or a subclass thereof).
...
#' @param ... Additional argument to pass to calcPrices
#' @references Mansley, Miller, Sheu & Weinberg (2023), "A price leadership model
#' for coordinated effects in merger analysis"
#' @seealso \code{\link{ple}} for the price leadership (partial coordination) model
#' @keywords methods
setGeneric (
